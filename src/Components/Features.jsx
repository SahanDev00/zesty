  ...
  return (
    <div className='w-full xl:w-[90%] relative mt-20 flex mx-auto justify-center pb-5'>
      <div className='w-full h-full mx-auto'>
        <h1 className='mt-10 bg-gradient-to-b uppercase from-gray-200 to-gray-400 bg-clip-text text-center text-5xl sm:text-6xl font-semibold leading-snug text-transparent dark:from-white dark:to-slate-500/40'>Services</h1>
        <div className='w-[95%] lg:w-[80%] xl:w-[60%] mx-auto h-full mt-10'>
          <Slider {...settings}>
            {[...Array(5)].map((_, index) => (
              <div key={index} className='w-[90%] md:w-full mx-auto border border-gray-600 rounded-xl p-6 md:p-4 bg-black/30 dark:bg-black/50'>
