...
const Pricing = () => {
  return (
    <div className='w-full mt-28 pb-10 relative'>
        <h1 className='mt-20 bg-gradient-to-b uppercase from-gray-700 to-gray-300/80 bg-clip-text text-center text-5xl sm:text-6xl font-semibold leading-snug text-transparent dark:from-white dark:to-slate-900/10'>PRICING</h1>
        <div className='w-[95%] lg:w-[90%] xl:w-[70%] mx-auto grid grid-cols-1 sm:grid-cols-3 mt-10 items-center'>
            <div className='mx-auto w-[90%] sm:w-[90%] justify-center items-center flex rounded-t-xl'>
                <div className='w-[95%] lg:w-[85%] hover:scale-105 duration-300 h-full'>
                    <div className='h-[60px] md:h-[80px] border bg-black/50 rounded-t-xl flex justify-center items-center'>
                    ...
                    <ConfettiButton className='h-[50px] md:h-[60px] border w-full bg-black/50 rounded-b-xl flex justify-center items-center relative'>
            ...
            <div className='mx-auto w-[94%] sm:w-[90%] h-full items-center justify-center flex rounded-t-xl mt-10 sm:mt-0'>
                <div className='w-[97%] lg:w-[89%] hover:scale-105 duration-300'>
                    ...
                    <hr />
                    <div className='w-full flex-col flex mx-auto space-y-3 items-center text-gray-300 mt-5 px-1'>
