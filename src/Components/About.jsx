...
const About = () => {
  return (
    <div id='about' className='w-[90%] mx-auto mt-32'>
        <h1 className='mt-10 bg-gradient-to-b uppercase from-gray-700 to-gray-300/80 bg-clip-text text-center text-5xl sm:text-6xl font-semibold leading-snug text-transparent dark:from-white dark:to-slate-900/10'>About Us</h1>
        <p className="pointer-events-none w-[95%] sm:w-[85%] md:w-[80%] lg:w-[75%] mt-7 mx-auto whitespace-pre-wrap bg-gradient-to-b from-gray-600 to-gray-300/80 bg-clip-text text-center text-[16px] md:text-lg lg:text-xl font-semibold leading-relaxed md:leading-loose text-transparent dark:from-white dark:to-slate-900/10">
